...
from transformers import XLNetConfig, AutoModelForMaskedLM
...
@TokenEmbedder.register("pretrained_transformer_masking")
class PretrainedTransformerMaskingEmbedder(TokenEmbedder):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer_model = AutoModelForMaskedLM.from_pretrained(model_name)
        ...
        self._mask_token_id = tokenizer.tokenizer.mask_token_id
    ...
    def forward(
        ...
        if fold_long_sequences:
            ...
            if masked_lm_labels is not None:
                masked_lm_labels, _, _ = self._fold_long_sequences(
                    masked_lm_labels, segment_concat_mask, type_ids
                )
        ...
        parameters = {"input_ids": token_ids, "attention_mask": transformer_mask.float(), "output_hidden_states": True}
        if type_ids is not None:
        ...
        return embeddings, masked_lm_loss
