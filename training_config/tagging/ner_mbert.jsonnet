...

{
  ...
  "model": {
    ...
    "parallel_consistency_coefficient": 1, // std.parseJson(std.extVar("parallel_consistency_coefficient")),
    ...
    "parallel_asymmetric": false,
    "parallel_consistency_threshold": 0.5,
    "ner_use_crf": false,
    "parallel_bag_loss": true
  },
  "data_loader": {
